...
function checkPrefixedVersionExists (fileToCheck, paths, prefix) {
  var index = findIndex(function (p) {
    var currentFile = path.basename(p)
...
module.exports = function resolveGlob (id, base, opts) {
  ...
  var patterns = reduce(function (acc, p) {
  ...
  return globby(patterns)
    .then(function (files) {
      return flow(
        ...
        filter(function (file) { return hasExtensions(file, extensions) }),
